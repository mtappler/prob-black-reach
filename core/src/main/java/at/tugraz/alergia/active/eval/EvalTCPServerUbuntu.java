...
/**
 * The TCP model used in the evaluation is based on a translation of the Ubuntu TCP-server model 
 * learned by Paul Fiterau-Brostean and others. (available at http://automata.cs.ru.nl/BenchmarkTCP/Mealy)
 *
 */
public class EvalTCPServerUbuntu {
	...
	public static final int STEP_BOUND = 40;
	public static final double STOP_PROBABILITY = 0.025;
	public static final int BASE_BATCH_SIZE = 500;
	...
	public static ActiveTestingStrategyInference monolithicLarge(Adapter adapter, InputSymbol[] inputs,
		...
		int nrRounds = 1;
		int batchSize = BASE_BATCH_SIZE * ROUNDS * 5;
		long initialSeed = 0;
	...
	public static void main(String[] args) throws Exception {
		...
		InputSymbol[] inputs = new InputSymbol[] { new InputSymbol("CLOSECONNECTION"), 
				...
				new InputSymbol("SYN_plus_ACK_paren_V_c_V_c_0_paren_"), 
				new InputSymbol("RST_paren_V_c_V_c_0_paren_"), 
				new InputSymbol("ACCEPT"),
				new InputSymbol("FIN_plus_ACK_paren_V_c_V_c_0_paren_"), 
				new InputSymbol("LISTEN"), 
				new InputSymbol("SYN_paren_V_c_V_c_0_paren_"),
				new InputSymbol("RCV"),
				new InputSymbol("ACK_plus_RST_paren_V_c_V_c_0_paren_"),
				new InputSymbol("CLOSE"),
		...
		Experiment monolithicLargeExperiment = new Experiment(path, monolithicLarge(adapter, inputs, prismLocation),
				adapter, seeds, propertiesFile, "monolithic-large", properties);
