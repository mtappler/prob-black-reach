...
public class EvalFirst {
	...
	public static final Predicate<List<InputOutputStep>> alternativeStoppingCriterion = (
			List<InputOutputStep> trace) -> false;// trace.get(trace.size()-1).getOutput().stringRepresentation().contains("goal");
	...
	public static void main(String[] args) throws Exception {
		...
		String path = "log/gridworld/journal/first";
