...
public class CtmcState extends McState<TimeStep>{

	CtmcState(String id, OutputSymbol label, PTANode<TimeStep> ptaNode) {
		super(id, label, ptaNode);
	}

	@Override
	public void normalize(SampleData<TimeStep> sampleData) {
